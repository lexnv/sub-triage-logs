...
impl WarpTime {
    fn extract_time(line: &str) -> chrono::NaiveDateTime {
        ...
        chrono::NaiveDateTime::parse_from_str(&current, "%Y-%m-%d %H:%M:%S.%f").unwrap()
    }
